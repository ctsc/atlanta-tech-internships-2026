...
## Submitting a New Internship Listing

The easiest way to contribute is through our structured issue form:

1. Go to [Submit a New Internship](https://github.com/ctsc/atlanta-tech-internships-2026/issues/new?template=new-internship.yml)
2. Fill out the required fields:
   - **Company Name** — The company offering the internship
...
If everything checks out, the listing is added to the repo and your issue is closed with a confirmation comment. If there's a problem (dead link, duplicate, not a valid internship), the bot will explain why and close the issue.
...
Open a regular issue (not the internship template) if you have questions, suggestions, or bug reports.

Thank you for contributing!

— [Carter](https://github.com/ctsc), President, IEEE @ Georgia State
